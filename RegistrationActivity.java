...
public class RegistrationActivity extends AppCompatActivity {
    ...
    //Creating Variables for Buttons, EditText,...etc.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cnfPwdEdt = findViewById(R.id.idedtCnPwd);
        ...
        // Set the OnClickListener to register button
                    ...
                    mAuth.createUserWithEmailAndPassword(userName,pwd).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful()){
                                ...
                                Intent i = new Intent(RegistrationActivity.this, LoginActivity.class);
                                startActivity(i);
                                finish(); // Close the current activity - Registration Activity
                            }else{
                                loadingPB.setVisibility(View.GONE);
                                Toast.makeText(RegistrationActivity.this,"Failed to Register the user.", Toast.LENGTH_SHORT).show();
